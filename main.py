...
st.markdown("<h1 style='text-align: center; color: Black;'>NIE Institute Of Technology, Mysuru</h1>", unsafe_allow_html=True)
st.markdown("<h6 style='text-align: center; color: Black;'><hr></h6>", unsafe_allow_html=True)
st.markdown("<h2 style='text-align: center; color: Black;'>Empowering Education with AI</h2>", unsafe_allow_html=True)
st.markdown("<h4 style='text-align: center; color: Black;'>An application created towards fulfillment of final year project by : <br><br>Abhigyan Aman &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp[4NN20CS001]<br>Aditya &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp[4NN20CS005]<br>Ravala Pallavika &nbsp&nbsp&nbsp&nbsp[4NN20CS042]<br>&nbsp Sai Charitha &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp[4NN20CS043]</h2>", unsafe_allow_html=True)


def course_recommendation():
    st.markdown("<h2 style='text-align: center; color: Black;'>Selective Course Recommendation System</h2>", unsafe_allow_html=True)
...
def content_summarization():
    st.title(':orange[Content Summarization] :notebook:')
...
def performance_evaluation():
    st.markdown("<h2 style='text-align: center; color: Black;'>Performance Evaluation System</h2>", unsafe_allow_html=True)
    st.markdown("<h4 style='text-align: center; color: Black;'>Elevate your knowledge in a way determined by Machine learning algorithms to empower your learning experince.</h4>", unsafe_allow_html=True)
    ...
    if st.button('Generate QP'):
        st.markdown("<h2 style='text-align: center; color: Black;'>Performance Evaluation Report</h2>", unsafe_allow_html=True)
        st.markdown("<h6 style='text-align: center; color: Black;'>Based on your inputs the user readyness percentage to try next level is: </h6>", unsafe_allow_html=True)
        st.markdown("<h2 style='text-align: center; color: Black;'>"+str(percent)+" % \rready</h2>", unsafe_allow_html=True)
        st.markdown("<h2 style='text-align: center; color: Black;'> Based on your performance you can try these questions</h2>", unsafe_allow_html=True)
